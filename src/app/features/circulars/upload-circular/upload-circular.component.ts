            ...
            <div class="card-body">
              <form [formGroup]="uploadForm" (ngSubmit)="onSubmit()">
                <div class="row g-4">
                  <div class="col-md-6">
                    ...
                    <input 
                      ...
                      [class.is-invalid]="uploadForm.get('referenceNumber')?.invalid && uploadForm.get('referenceNumber')?.touched"
                    >
                  ...
                  <div class="col-md-6">
                    <label for="regulatoryBody" class="form-label fw-semibold">Regulatory Body *</label>
                    <select 
                      class="form-select" 
                      id="regulatoryBody" 
                      formControlName="regulatoryBody"
                      [class.is-invalid]="uploadForm.get('regulatoryBody')?.invalid && uploadForm.get('regulatoryBody')?.touched"
                    >
                      ...
                      <option value="NPCI">National Payments Corporation (NPCI)</option>
                    </select>
                    <div class="invalid-feedback">
                  ...
                  <div class="col-md-6">
                    ...
                    <select 
                      ...
                      [class.is-invalid]="uploadForm.get('priority')?.invalid && uploadForm.get('priority')?.touched"
                    >
                  ...
                  <div class="col-md-6">
                    ...
                    <input 
                      ...
                      [class.is-invalid]="uploadForm.get('issuedDate')?.invalid && uploadForm.get('issuedDate')?.touched"
                    >
                    <div class="invalid-feedback">
                  ...
                  <div class="col-md-6">
                    ...
                    <input 
                      ...
                      [class.is-invalid]="uploadForm.get('effectiveDate')?.invalid && uploadForm.get('effectiveDate')?.touched"
                    >
                    <div class="invalid-feedback">
                  ...
                  <div class="col-12">
                    ...
                    <textarea 
                      ...
                      [class.is-invalid]="uploadForm.get('content')?.invalid && uploadForm.get('content')?.touched"
                    ></textarea>
                    <div class="invalid-feedback">
                      Content is required
                    </div>
                ...
                <div class="d-flex justify-content-between mt-4">
                  <button type="button" class="btn btn-outline-secondary" routerLink="/circulars">
                  ...
                  <div class="d-flex gap-2">
                    ...
                    <button type="submit" class="btn btn-primary" [disabled]="uploadForm.invalid || isSubmitting">
            ...
            <div class="card-body">
              <div class="mb-3">
                ...
                <ul class="list-unstyled small">
                  <li><i class="fas fa-check text-success me-2"></i>Reference number</li>
                  <li><i class="fas fa-check text-success me-2"></i>Regulatory body</li>
                  <li><i class="fas fa-check text-success me-2"></i>Title and description</li>
                  <li><i class="fas fa-check text-success me-2"></i>Category and priority</li>
                  <li><i class="fas fa-check text-success me-2"></i>Important dates</li>
                  <li><i class="fas fa-check text-success me-2"></i>Full content</li>
                </ul>
              </div>
              ...
              <div class="mb-3">
                ...
                <ul class="list-unstyled small">
                  <li><i class="fas fa-file-pdf text-danger me-2"></i>PDF files preferred</li>
                  <li><i class="fas fa-file-word text-primary me-2"></i>DOC/DOCX accepted</li>
                  <li><i class="fas fa-weight-hanging text-warning me-2"></i>Max 10MB per file</li>
                  <li><i class="fas fa-shield-alt text-success me-2"></i>Virus scan included</li>
                </ul>
              </div>
              
              <div class="alert alert-info">
                <i class="fas fa-robot me-2"></i>
                <strong>AI Processing:</strong> After upload, the circular will be automatically analyzed for action items and department assignments.
              </div>
            </div>
          </div>
        </div>
