            ...
            <div class="card-body">
              <form [formGroup]="taskForm" (ngSubmit)="onSubmit()">
                <div class="row g-4">
                  ...
                  <div class="col-md-6">
                    <label for="circularId" class="form-label fw-semibold">Related Circular</label>
                    <select 
                      class="form-select" 
                      id="circularId" 
                    ...
                    >
                      ...
                      <option *ngFor="let circular of circulars$ | async" [value]="circular.id">
                  ...
                  <div class="col-md-6">
                    ...
                    <select 
                      ...
                      [class.is-invalid]="taskForm.get('department')?.invalid && taskForm.get('department')?.touched"
                      (change)="onDepartmentChange($event)"
                    >
                      <option value="">Select Department</option>
                      <option *ngFor="let dept of departments$ | async" [value]="dept.name">
                        {{ dept.name }}
                      </option>
                    </select>
                    <div class="invalid-feedback">
                  ...
                  <div class="col-md-6">
                    <label for="assignedTo" class="form-label fw-semibold">Assign To *</label>
                    <select 
                      class="form-select" 
                      id="assignedTo" 
                    ...
                    >
                      ...
                      <option *ngFor="let user of filteredUsers$ | async" [value]="user.id">
                  ...
                  <div class="col-md-6">
                    <label for="estimatedHours" class="form-label fw-semibold">Estimated Hours *</label>
                    <input 
                      type="number" 
                      class="form-control" 
                      id="estimatedHours" 
                ...
                <div class="d-flex justify-content-between mt-4">
                  <button type="button" class="btn btn-outline-secondary" routerLink="/tasks">
            ...
            <div class="card-body">
              <div class="mb-3">
                ...
                <ul class="list-unstyled small">
                  ...
                  <li><i class="fas fa-check text-success me-2"></i>Provide detailed descriptions</li>
                  <li><i class="fas fa-check text-success me-2"></i>Set realistic deadlines</li>
                  <li><i class="fas fa-check text-success me-2"></i>Assign to appropriate department</li>
                  <li><i class="fas fa-check text-success me-2"></i>Use relevant tags</li>
                </ul>
              </div>
              
              <div class="alert alert-info">
                <i class="fas fa-info-circle me-2"></i>
                <strong>Auto-notifications:</strong> Assigned users will receive email notifications about new tasks.
              </div>
            </div>
          </div>
        </div>
...
export class CreateTaskComponent implements OnInit {
  ...
  constructor(
    ...
    this.taskForm = this.fb.group({
      ...
      estimatedHours: ['', [Validators.required, Validators.min(1), Validators.max(200)]],
  ...
  onDepartmentChange(event: any) {
    ...
    if (selectedDepartment) {
      this.filteredUsers$ = this.users$.pipe(
        map(users => users.filter(user => user.department?.name === selectedDepartment))
      );
    } else {
      this.filteredUsers$ = this.users$;
    }
  ...
  onSubmit() {
    if (this.taskForm.valid) {
      ...
      const taskData: CreateTaskRequest = {
        ...this.taskForm.value,
        tags: this.taskForm.value.tags ? this.taskForm.value.tags.split(',').map((tag: string) => tag.trim()) : []
      };
